...
description: "Creates an isolated git worktree workspace using native tools or git fallback before starting feature work. Use when starting work that needs isolation from the current workspace."
when_to_use: "worktree, isolated workspace, git worktree, feature branch, isolate changes, before implementation, workspace isolation"
---
